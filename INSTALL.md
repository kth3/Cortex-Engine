...
터미널에서 다음 명령어를 실행하십시오:
```bash
codex mcp add --env PYTHONPATH=C:/절대/경로/참조/.agents/scripts cortex-mcp -- uv run --project C:/Users/SSAFY/Downloads/Workflow/PROJECT/.agents python C:/절대/경로/참조/.agents/scripts/cortex_mcp.py
```
